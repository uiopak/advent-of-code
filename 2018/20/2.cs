...
namespace Day20
{
    ...
    {
        public static Dictionary<Tuple<int, int>, List<int>> dictionary = new Dictionary<Tuple<int, int>, List<int>>();
        //public class expr
        //{
        ...
        public static int getDistanceN(int n, int e, int s, int w)
        {
            return Math.Abs(n - s) + Math.Abs(e - w);
        }

        //public static List<Tuple<int, int>> addExpres(ref int poz, int end, string input)
        //{
        //    var tmpStr = new List<List<char>>();
        //    var tmpInt = new List<List<char>>();
        //    var distanceList = new List<Tuple<int, int>>();
        ...
        //                    }
        //                    if (distanceList.Count > 0 && tmpCharList.Count > 0)
        //                    {
        //                        for (var i = 0; i < distanceList.Count; i++)
        //                        {

        //                            distanceList[i] = new Tuple<int, int>(distanceList[i].Item1 + distanceDoors.Item1, distanceList[i].Item2 + distanceDoors.Item2);
        //                        }
        //                    }
        //                    else if (distanceList.Count == 0 && tmpCharList.Count >= 0)
        //                    {
        //                        distanceList.Add(distanceDoors);
        //                    }
        //                    tmpCharList = new List<char>();
        ...
        //                    //    }
        //                    //}
        //                    var distanceList2 = new List<Tuple<int, int>>();
        //                    if (distanceList.Count > 0 && tmpCharList.Count > 0)
        //                    {
        //                        for (var i = 0; i < distanceList.Count; i++)
        //                        {
        ...
        //                            {
        //                                distanceList2.Add(new Tuple<int, int>(distanceList[i].Item1 + tmp[j].Item1, distanceList[i].Item2 + tmp[j].Item2));
        //                            }
        //                        }

        //                        distanceList = distanceList2;
        //                    }
        //                    else if (distanceList.Count == 0)
        //                    {
        //                        distanceList = distanceList2;
        //                    }
        //                    //distanceDoors = new Tuple<int, int>(distanceDoors.Item1 + tmp.Item1, distanceDoors.Item2 + tmp.Item2);
        ...
        //    {
        //        distanceList.Add(new Tuple<int, int>(getDistance(tmpCharList), tmpCharList.Count));
        //    }
        //    return distanceList;
        //}
        ...
        //    return tst2;
        //}
        public static void addToDic(int poz, int n, int e, int s, int w)
        {
            var key = new Tuple<int, int>(n - s, e - w);
            if (dictionary.ContainsKey(key))
            {
                dictionary[key].Add(poz);
            }
            else
            {
        ...
        public static void addToDictionary(ref int poz, int end, int n, int e, int s, int w, string input)
        {
            int sn = n;
            int ss = s;
            int se = e;
            ...
            while (run)
            {
                if (end >= poz)
                {
                    ...
                    switch (c)
                    {
                        ...
                        case '(':
                            poz++;
                            addToDictionary(ref poz, findEnd(poz, 1, input), n, e, s, w, input);
                            break;
                        case '|':
                            poz++;
                            addToDictionary(ref poz, findEnd(poz, 1, input), sn, se, ss, sw, input);
                            break;
                        case ')':
                            poz++;
                            run = false;
        ...
        public static void Main()
        {
            ...
            int poz = 0;
            addToDictionary(ref poz, findEnd(poz, 1, input), 0, 0, 0, 0, input);
            //var tmpExpr = new expr();
            // zamieniæ ( na (( ) na )) i | na )|(
            //int no = 0;
            //int nc = 0;
            ...
            var t = dictionary.Count(c => c.Value.Min() >= 1000);
            Console.WriteLine(t);
            //prev = t;
